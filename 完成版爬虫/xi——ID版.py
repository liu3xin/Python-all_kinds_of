...
if True:
    with ThreadPoolExecutor(100) as t:
        for im in range(1,2000):
            im = im*10
            t.submit(one_page,f'https://www.ixigua.com/tlb/comment/article/v5/tab_comments/?tab_index=0&count=10&offset={im}&group_id={idi}&item_id={idi}&aid=1768')
